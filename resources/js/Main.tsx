...
import ModalEdit from "../react/components/ModalEdit";
import ModalDelete from "../react/components/ModalDelete";
import TaskList from "../react/components/TaskList";
import SelectProject from "../react/components/SelectProject";
import AddTaskForm from "../react/components/AddTaskForm";

function Main () {
    const [projectId, setProjectId] = useState('');
    const projectsData = document.getElementById('main').getAttribute('data-projects');
